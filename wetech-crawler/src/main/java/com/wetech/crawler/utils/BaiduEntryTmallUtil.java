 ...
 * 百度进入其他网页
 */
public class BaiduEntryTmallUtil {
    ...
    public static WebDriver baiduJumpTmall(WebDriver driver) throws Exception{
        ...
        wait.until(new ExpectedCondition<WebElement>(){
            ...
            public WebElement apply(WebDriver text) {
                return text.findElement(By.linkText("天猫tmall"));
            }
        });
        //标签页切换
        WebElement tmallLink = driver.findElement(By.linkText("天猫tmall"));
        tmallLink.click();
        //关闭第一页并切换到第二页
        ...
        InputUtil.chineseInput(tmSearchBox, "衬衫女");
        //点击搜索按钮
